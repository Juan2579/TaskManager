    ...
    <footer className="w-full h-auto flex justify-center items-center py-8 bg-[#8FCFDC] dark:bg-[#0e3261]">
        <section className="flex flex-col items-center justify-center gap-4">
            ...
            <div className="flex gap-4">
                <a href="">
                    <svg className="w-10 lg:w-14 fill-current text-cyan-800 hover:scale-[1.2] hover:opacity-70 dark:text-white" xmlns="http://www.w3.org/2000/svg" focusable="false" viewBox="0 0 12 12">
                ...
                <a href="">
                    <svg className="w-10 lg:w-14 fill-current text-cyan-800 hover:scale-[1.2] hover:opacity-70 dark:text-white" version="1.1" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" >
                ...
                <a href="">
                    <svg className="w-10 lg:w-14 fill-current text-cyan-800 hover:scale-[1.2] hover:opacity-70 dark:text-white" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
