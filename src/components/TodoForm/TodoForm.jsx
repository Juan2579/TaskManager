...
export const TodoForm = ({addTask, setOpenModal}) => {
    ...
    return (
        <form
            ...
            className="min-w-[288px] min-h-[400px] flex flex-col items-center gap-5 fixed top-[calc(400px - 60%)] px-5 py-8 shadow-xl rounded-lg bg-[#90D2DD] border-2 border-white z-10 lg:min-w-[500px] lg:gap-12 lg:py-12">
            <h2 
