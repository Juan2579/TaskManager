export const TodoItem = (props) => {
  ...
  return (
    <li className="min-w-[288px] max-w-[350px] mx-auto h-12 flex items-center justify-between px-5 bg-white rounded-xl shadow-xl border-2 border-cyan-100 hover:scale-[1.05] lg:min-w-[450px] lg:h-16 dark:bg-[#2166a3]">
        ...
        <button onClick={props.onDelete}>
          <svg className="fill-current text-gray-900 w-7 h-7 hover:scale-[1.2] hover:opacity-70 lg:w-12 lg:h-12 dark:text-white" id="Layer_1" version="1.1" viewBox="0 0 91 91" xmlns="http://www.w3.org/2000/svg">
