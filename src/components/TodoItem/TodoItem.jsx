export const TodoItem = (props) => {
  ...
  return (
    <li className="min-w-[288px] max-w-[350px] mx-auto h-12 flex items-center justify-between px-5 bg-white rounded-xl shadow-xl border-2 border-cyan-100 hover:scale-[1.05] lg:min-w-[450px] lg:h-16">
        <button onClick={props.onComplete}>
          <svg className={`fill-current ${!props.completed && "text-blue-200"} ${props.completed && "text-green-400"}  w-6 h-5 hover:scale-[1.2] hover:opacity-70 lg:w-10 lg:h-8`} width="25px" height="20px" version="1.1" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
        ...
        <p className={`px-5 text-ellipsis whitespace-nowrap overflow-hidden ${props.completed && 'line-through'} lg:text-xl`}>{props.name}</p>
        <button onClick={props.onDelete}>
          <svg className="fill-current text-gray-900 w-6 h-5 hover:scale-[1.2] hover:opacity-70 lg:w-12 lg:h-12 " id="Layer_1" version="1.1" viewBox="0 0 91 91" xmlns="http://www.w3.org/2000/svg">
