export const TodoLoading = () => {
  return (
    <div className="flex flex-col justify-center items-center gap-4">
        <svg className="w-12 fill-current text-cyan-800 animate-spin lg:w-16" id="Layer_1" version="1.1" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
        ...
        <p className="font-bold text-gray-600 lg:text-xl">Loading your tasks...</p>
    </div>
  )
}
