...
export const Header = () => {
    return (
        <header className="w-full h-20 flex justify-start items-center py-3 px-3 bg-[#8FCFDC]">
            <nav className="flex items-center justify-center">
                <li className="list-none">
                    <svg className="w-14 fill-current text-cyan-800" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><g id="outline">
                ...
                <li className="list-none font-bold text-2xl text-cyan-800">Task Manager</li>
            </nav>
        </header>
    )
}
